...
# Outputs helper/data/components.json with per-component triangle ranges (original STL
...
OUT = "/home/vitor/workspace/personal/nobuffer-site/helper/data/components.json"
